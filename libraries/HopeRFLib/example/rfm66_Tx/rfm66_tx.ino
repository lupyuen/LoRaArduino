 ...
 * file       rfm66_tx.ino
 * hardware   HopeDuino
 * software   send message via rfm66
...
byte str[21] = {'H','o','p','e','R','F',' ','R','F','M',' ','C','O','B','R','F','M','6','6','S'};

void setup()
{
 radio.Modulation     = FSK;
 radio.Frequency      = 868000;         //note: rfm66 only for 868MHz or 915MHz
 radio.OutputPower    = 15;             //15dBm OutputPower
